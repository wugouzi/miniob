...
MAX LBRACE ID RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, NULL, $3, $1, A_MAX);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
| MIN LBRACE ID RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, NULL, $3, $1, A_MIN);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
| AVG LBRACE ID RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, NULL, $3, $1, A_AVG);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
| MAX LBRACE ID DOT ID RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, $3, $5, $1, A_MAX);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
| MIN LBRACE ID DOT ID RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, $3, $5, $1, A_MIN);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
| AVG LBRACE ID DOT ID RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, $3, $3, $1, A_MAX);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
| COUNT LBRACE NUMBER RBRACE {
  ...
  snprintf(str, 10, "%d", $3);
  aggregation_attr_init(&attr, NULL, str, $1, A_COUNT);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
| COUNT LBRACE STAR RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, NULL, "*", $1, A_COUNT);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);

}
| COUNT LBRACE ID RBRACE {
  RelAttr attr;
  aggregation_attr_init(&attr, NULL, $3, $1, A_COUNT);
  selects_append_attribute(&CONTEXT->ssql->sstr.selection, &attr);
}
;
